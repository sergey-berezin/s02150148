...
namespace PredictorLibrary
{
    ...
    public class Predictor
    {
        ...
        public Predictor(string path_to_imgs,
                         Output write,
                         string path_to_model = "..\\PredictorLibrary\\resnet18-v1-7.onnx") //"..\\..\\..\\..\\PredictorLibrary\\resnet18-v1-7.onnx"
        {
        ...
        public void ProcessDirectory()
        {
            ...
            foreach (var path in  Directory.GetFiles(path_to_imgs, "*.jpg"))
            {
        ...
        public static List<Result> GetDatabaseDir(string dir)
        {
            ...
            using (var db = new ResultContext())
            {
                foreach (var path in Directory.GetFiles(dir, "*.jpg"))
                {
            ...
            Console.WriteLine("Returning from classifier");
            return ret;
        }
        ...
        private void thread_method()
        {
            ...
            while (filenames.TryDequeue(out path))
            {
                ...
                {
                    Console.WriteLine("Found similar: " + info);
                    write?.Invoke(info);
                    return;
                }

                Console.WriteLine("No similar found, processing");
